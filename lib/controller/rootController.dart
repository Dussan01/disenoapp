...
import 'package:disenoapp/controller/Auth.dart';
import 'package:disenoapp/views/BienvenidaPage.dart';
...
class _RootPageState extends State<RootPage> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (_authStatus) {
      ...
      return BienvenidaPage(auth: widget.auth,onSignIn: _signIn,);
      break;
      case AuthStatus.signIn:
        return DashbordPage( auth: widget.auth,onSignedOut: _signOut,);//menu_page.dart
        break;
    }
